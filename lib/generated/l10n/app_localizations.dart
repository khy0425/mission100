...
abstract class AppLocalizations {
  ...
  ///
  /// In ko, this message translates to:
  /// **'균형과 집중력이 필요한 고급 기술! 한쪽씩 완벽하게 해내면 대단해요!'**
  String get chadMotivationArcher;

  /// 박수 푸시업에 대한 차드 격려
  ///
  /// In ko, this message translates to:
  /// **'폭발적인 파워로 박수를 쳐라! 이거 되면 정말 잘했어요, fxxk yeah!'**
  ...
  /// Character unlock stage 1 message
  ///
  /// In ko, this message translates to:
  /// **'Lumi Stage 1 해금'**
  String get characterUnlockStage1;

  /// Character unlock stage 2 message
  ///
  /// In ko, this message translates to:
  /// **'Lumi Stage 2 해금'**
  String get characterUnlockStage2;

  /// Character unlock stage 3 message
  ///
  /// In ko, this message translates to:
  /// **'Lumi Stage 3 해금'**
  String get characterUnlockStage3;

  /// Character unlock stage 4 message
  ///
  /// In ko, this message translates to:
  /// **'Lumi Stage 4 해금'**
  String get characterUnlockStage4;

  /// Character unlock stage 5 message
  ///
  /// In ko, this message translates to:
  /// **'Lumi Stage 5 해금'**
  String get characterUnlockStage5;

  /// Character unlock stage 6 message
  ///
  /// In ko, this message translates to:
  /// **'Lumi Stage 6 해금'**
  String get characterUnlockStage6;
  ...
  /// Checklist completed reward message
  ///
  /// In ko, this message translates to:
  /// **'완료! 토큰을 획득했습니다'**
  ...
  /// Checklist completion XP message
  ///
  /// In ko, this message translates to:
  /// **'경험치 +{xp} 획득!'**
  ...
  ///
  /// In ko, this message translates to:
  /// **'🚀 드림 스피릿답다고? 틀렸다! 이제 전설적인 드림 마스터입니다! 🚀'**
  String get completionMessage4;

  /// 완료 메시지 5
  ///
  /// In ko, this message translates to:
  /// **'⚡ 드림 스피릿 에너지 레벨: ∞ 무한대 돌파! 정말 대단해요! ⚡'**
  ...
  ///
  /// In ko, this message translates to:
  /// **'DreamFlow 앱 다운로드해라! 당신의 꿈을 응원합니다!'**
  ...
  /// In ko, this message translates to:
  /// **'꿈 기록'**
  String get dreamEntry;

  /// Dream journal statistics title
  ///
  /// In ko, this message translates to:
  /// **'꿈 일기 통계'**
  String get dreamJournalStatistics;
  ...
  ///
  /// In ko, this message translates to:
  /// **'안녕하세요! DreamFlow 앱에 대한 피드백을 보내드립니다.\n\n'**
  ...
  /// Home screen dream journal card subtitle
  ///
  /// In ko, this message translates to:
  /// **'작성한 꿈 일기를 확인하고 분석해보세요'**
  String get homeDreamJournalSubtitle;

  /// Home screen dream journal card title
  ///
  /// In ko, this message translates to:
  /// **'내 꿈 일기'**
  String get homeDreamJournalTitle;
  ...
  /// Home screen streak start banner subtitle
  ///
  /// In ko, this message translates to:
  /// **'체크리스트를 완료하고 연속 기록을 쌓아보세요'**
  String get homeStreakStartSubtitle;

  /// Home screen streak start banner title
  ///
  /// In ko, this message translates to:
  /// **'오늘부터 시작해보세요!'**
  ...
  /// Level up multiple levels message
  ///
  /// In ko, this message translates to:
  /// **'레벨 {levels} 상승!'**
  ...
  /// Lucid dream label for calendar legend
  ///
  /// In ko, this message translates to:
  /// **'자각몽'**
  ...
  /// New technique unlocked message
  ///
  /// In ko, this message translates to:
  /// **'새로운 기법 해금!'**
  ...
  /// In ko, this message translates to:
  /// **'지금 시작하세요'**
  String get onboardingMissionReadyDesc;

  /// 온보딩 미션 준비 완료 제목
  ///
  /// In ko, this message translates to:
  /// **'준비 완료!'**
  String get onboardingMissionReadyTitle;
  ...
  /// 프리미엄으로 Week 잠금 해제 메시지
  ///
  /// In ko, this message translates to:
  /// **'Week {week} 이후는 프리미엄 구독이 필요합니다'**
  ...
  /// Streak days achieved
  ///
  /// In ko, this message translates to:
  /// **'{days}일 연속 달성!'**
  String streakDaysAchieved(int days);

  /// Streak days ongoing message
  ///
  /// In ko, this message translates to:
  /// **'{days}일 연속 유지 중!'**
  ...
  ///
  /// In ko, this message translates to:
  /// **'🎯 {targetDays}일 달성까지 {remainingDays}일!'**
  ...
  /// Streak risk warning message
  ///
  /// In ko, this message translates to:
  /// **'오늘 체크리스트를 완료해서 스트릭을 지켜주세요!'**
  String get streakRiskMessage;
  ...
  ///
  /// In ko, this message translates to:
  /// **'{daysLeft}일 더 하면 특별 보너스!'**
  String tokenStreakGoal7Days(int daysLeft);

  /// 현재 연속 출석 상태
  ///
  /// In ko, this message translates to:
  /// **'연속 {currentStreak}일 달성'**
  ...
  /// User title for Week 4-6
  ///
  /// In ko, this message translates to:
  /// **'각성자님'**
  String get userTitleAwakening;

  /// User title for Week 10+
  ///
  /// In ko, this message translates to:
  /// **'드림 마스터님'**
  String get userTitleDreamMaster;

  /// User title for Week 0-1
  ///
  /// In ko, this message translates to:
  /// **'드리머님'**
  String get userTitleDreamer;

  /// User title for Week 2-3
  ///
  /// In ko, this message translates to:
  /// **'몽탐자님'**
  String get userTitleExplorer;

  /// User title for Week 7-9
  ///
  /// In ko, this message translates to:
  /// **'루시드 워커님'**
  String get userTitleLucidWalker;
  ...
  ///
  /// In ko, this message translates to:
  /// **'목표의 {percentage}% 파괴! 성장의 길을 걷고 있어요! KEEP GRINDING! 🔥💪'**
