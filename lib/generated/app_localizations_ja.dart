...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get appTitle => '⚡ アルファ バトルグラウンド ⚡';

  @override
  String get repLogMessage => '弱者は数字を記録する。強者は歴史を作る 💪';
  ...
  @override
  String get performanceGodTier => '🚀 絶対完璧！超神皇帝を超越せし者！ 👑';

  @override
  String get performanceStrong => '🔱 鉄すらあなたの力に屈服！重力が降伏！伝説の獣よ！ 🔱';

  @override
  String get performanceMedium => '⚡ 良い！弱さが逃げ出している！アルファの嵐が到来！ ⚡';

  @override
  String get performanceStart => '💥 始まりが半分？違う！伝説の門は既に開かれた、未来の皇帝よ！ 💥';

  @override
  String get performanceMotivation => '君ならできる、ただやるだけ！ 🔥';

  @override
  String get motivationGod => 'あなたの筋肉は神の領域に到達。弱さは死んだ ⚡👑';

  @override
  String get motivationStrong => '諦めは弱者の言い訳。もっと激しく行け！ 🔱💪';

  @override
  String get motivationMedium => '良いスタート！さあ、より高みへ昇れ！ ⚡🚀';
  ...
  @override
  String get commonMistakes => 'よくある間違い';
