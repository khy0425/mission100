...
abstract class AppLocalizations {
  ...
  ///
  /// In ko, this message translates to:
  /// **'💡 CHAD MODE 활성화! 더 정확한 알림은 나중에 설정 가능! 🔥'**
  ...
  ///
  /// In ko, this message translates to:
  /// **'평균 완료율 90% 이상을 달성했습니다'**
  String get achievementCompletionRate90Desc;

  /// 완료율 90% 업적 동기부여
  ///
  /// In ko, this message translates to:
  /// **'완벽에 가까운 수행력을 보여주고 있습니다!'**
  ...
  ///
  /// In ko, this message translates to:
  /// **'목표의 {percentage}% 파괴! CHAD의 길을 걷고 있다! KEEP GRINDING! 🔥💪'**
  ...
  ///
  /// In ko, this message translates to:
  /// **'🧐 영원한 근육 기억이 새겨지고 있습니다!'**
  String get scientificFact4Impact;

  /// 과학적 팩트 4번 설명
  ///
  /// In ko, this message translates to:
  /// **'근섬유 핵이 증가하면 평생 동안 근육 성장의 템플릿이 됩니다.'**
  ...
  ///
  /// In ko, this message translates to:
  /// **'동조화된 운동 단위는 더 큰 힘을 더 효율적으로 생성합니다.'**
  ...
  ///
  /// In ko, this message translates to:
  /// **'새로운 혈관 형성으로 영양소와 산소 공급이 극대화됩니다.'**
  ...
  ///
  /// In ko, this message translates to:
  /// **'백업에 실패했습니다. 다시 시도해주세요.'**
  String get backupFailed;

  /// 백업 오류 메시지
  ///
  /// In ko, this message translates to:
  /// **'백업 중 오류가 발생했습니다: {error}'**
