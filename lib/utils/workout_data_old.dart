...
class DailyWorkout {
  ...
  List<ExerciseSet> toSets() {
    return [
      ExerciseSet(type: ExerciseType.pushup, reps: burpees),
...
class WorkoutData {
  ...
  static String getRPEDescription(int rpeLevel) {
    switch (rpeLevel) {
      case 1:
        return '여유롭게 할 수 있었어요. 더 도전할 수 있을 것 같아요!';
      case 2:
        return '약간 쉬웠지만 나쁘지 않았어요.';
      case 3:
        return '딱 적당한 난이도였어요. 완벽해요!';
      case 4:
        return '조금 힘들었지만 해낼 수 있었어요.';
      case 5:
        return '정말 힘들었어요. 한계에 도전했어요!';
      default:
        return '';
    }
  }
