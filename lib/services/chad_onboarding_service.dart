...
class ChadOnboardingService extends ChangeNotifier {
  ...
  Future<void> applyPersonalizationImmediately() async {
    try {
      ...
      for (String key in _collectedData.keys) {
