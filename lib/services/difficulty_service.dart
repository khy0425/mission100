...
class DifficultyService {
  ...
  Future<void> initialize() async {
    _currentDifficulty = await getCurrentDifficultyStatic();
  }

  /// 현재 난이도 가져오기 (정적 메소드)
  static Future<DifficultyLevel> getCurrentDifficultyStatic() async {
  ...
  /// 현재 난이도 가져오기 (인스턴스 메소드)
  Future<DifficultyLevel> getCurrentDifficulty() async {
    return await getCurrentDifficultyStatic();
  }
  ...
  /// 난이도 설정하기 (인스턴스 메소드)
  Future<void> setCurrentDifficulty(DifficultyLevel difficulty) async {
